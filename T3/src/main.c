...
//		if(i<2)
//		{
//			DRV8836_DriveMotor(MOTOR_TYPE_LEFT, MOTOR_DIR_CW, 3);
//			DRV8836_DriveMotor(MOTOR_TYPE_RIGHT, MOTOR_DIR_CCW, 3);
//		}
//		else
//		{
